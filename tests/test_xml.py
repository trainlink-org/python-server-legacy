...
def test_normal():
    ...
    assert utils.loadConfig() == {'ipAddress': '0.0.0.0', 'port': '6789', 'serialPort': '/dev/ttyUSBx', 'debug': 'True', 'logging': "True" }
...
def test_alternative():
    ...
    assert utils.loadConfig() == {'ipAddress': '127.0.0.1', 'port': '6789', 'serialPort': '/dev/ttyUSBx', 'debug': 'True', 'logging':'True'}
